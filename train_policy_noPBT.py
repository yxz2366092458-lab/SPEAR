...
parser.add_argument('--alg', type=str, default='qcombo', choices=['qcombo', 'coma', 'qcombo_adv'])
...
class LightTrainer:
    ...
    def __init__(self, alg, N_ROWS, N_COLUMNS, config, saving_dir=None, seed=0):
        ...
        if saving_dir is None:
            self.saving_dir = "results/{}{}_policy{}x{}_{}_{}".format(self.alg.name, self.config.alg.perturb,
                                                                      self.N_ROWS, self.N_COLUMNS, self.alg.lam,
